...
<script lang="js">
		...
		export default defineComponent({
				...
				async mounted() {
						...
						let articleData = await this.getArticleId();
						this.publish_checkbox = articleData.publish;
						this.tags = articleData.tags;
						
						let short_description_value = articleData.shortDescription; 
						...
						let article_text_value = articleData.articleText; 
				...
				methods: {
						async submitArticle(event) {
								...
								const url = 'https://localhost:48867/api/update-article';
